          ...
          actions: [
              {
                who: "driver",
                type: "debit",
                amount: rental.get_price(cars) + rental.deductible_calc
              },
              {
                who: "owner",
                type: "credit",
                amount: rental.get_price(cars) - rental.get_total_commission(rental.get_price(cars))
              },
              {
                who: "insurance",
                type: "credit",
                amount: rental.commission_calc(rental.get_price(cars))[:insurance_fee]
              },
              {
                who: "assistance",
                type: "credit",
                amount: rental.commission_calc(rental.get_price(cars))[:assistance_fee]
              },
              {
                who: "drivy",
                type: "credit",
                amount: rental.commission_calc(rental.get_price(cars))[:drivy_fee] + rental.deductible_calc
              },
          ]
        })
    end
